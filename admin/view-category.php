...
<?php include('include/header.php'); ?>
  ...
  <div class="card mb-3">
    ...
    <!-- Edit Button -->
    <a href="edit-category.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">
        Edit
    </a>

    <!-- Delete Button -->
    <a href="view-category.php?ids=<?php echo $row['id']; ?>" onclick="return confirmDelete()" class="btn btn-sm btn-danger">
       Delete
    </a>
</div>
